...
└── Flutter-自定义Scheme路由中心化-fr-Router.md   # fr:// 内部 URL 路由中心化：authority/path 拆分 + prefix 匹配 + handler 模式
`</doc-reffence>`
...
| Flutter-自定义Scheme路由中心化-fr-Router | **改 fr:// 路由 / 加新路由 / 做自定义 scheme 跳转 / MethodChannel 反注册 / 任何路由中心化重构时** |
