...
class DevCtrHelloApiKvV1KvSetRes {
  ...
  bool operator ==(Object other) =>
      ...
      other is DevCtrHelloApiKvV1KvSetRes && other.message == message;
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "DevCtrHelloApiKvV1KvSetRes[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "DevCtrHelloApiKvV1KvSetRes[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<DevCtrHelloApiKvV1KvSetRes> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<DevCtrHelloApiKvV1KvSetRes>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = DevCtrHelloApiKvV1KvSetRes.listFromJson(
          entry.value,
          growable: growable,
        );
      }
