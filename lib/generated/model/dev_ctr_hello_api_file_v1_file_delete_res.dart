...
class DevCtrHelloApiFileV1FileDeleteRes {
  /// Returns a new [DevCtrHelloApiFileV1FileDeleteRes] instance.
  ...
  /// Returns a new [DevCtrHelloApiFileV1FileDeleteRes] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static DevCtrHelloApiFileV1FileDeleteRes? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return DevCtrHelloApiFileV1FileDeleteRes(
  ...
  static List<DevCtrHelloApiFileV1FileDeleteRes> listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = DevCtrHelloApiFileV1FileDeleteRes.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, DevCtrHelloApiFileV1FileDeleteRes> mapFromJson(
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        final value = DevCtrHelloApiFileV1FileDeleteRes.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
