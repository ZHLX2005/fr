...
class DevCtrHelloApiWsV1WsRoomsRes {
  /// Returns a new [DevCtrHelloApiWsV1WsRoomsRes] instance.
  ...
  /// Room info
  List<DevCtrHelloApiWsV1RoomInfo> rooms;
  ...
  /// Returns a new [DevCtrHelloApiWsV1WsRoomsRes] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static DevCtrHelloApiWsV1WsRoomsRes? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return DevCtrHelloApiWsV1WsRoomsRes(
        rooms: DevCtrHelloApiWsV1RoomInfo.listFromJson(json[r'rooms']),
  ...
  static List<DevCtrHelloApiWsV1WsRoomsRes> listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = DevCtrHelloApiWsV1WsRoomsRes.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, DevCtrHelloApiWsV1WsRoomsRes> mapFromJson(dynamic json) {
    final map = <String, DevCtrHelloApiWsV1WsRoomsRes>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = DevCtrHelloApiWsV1WsRoomsRes.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
