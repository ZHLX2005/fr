...
class DevCtrHelloApiKvV1KvListReq {
  ...
  bool operator ==(Object other) =>
      ...
      other is DevCtrHelloApiKvV1KvListReq &&
          other.limit == limit &&
          other.offset == offset;
  ...
  @override
  String toString() =>
      'DevCtrHelloApiKvV1KvListReq[limit=$limit, offset=$offset]';
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "DevCtrHelloApiKvV1KvListReq[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "DevCtrHelloApiKvV1KvListReq[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<DevCtrHelloApiKvV1KvListReq> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<DevCtrHelloApiKvV1KvListReq>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = DevCtrHelloApiKvV1KvListReq.listFromJson(
          entry.value,
          growable: growable,
        );
      }
