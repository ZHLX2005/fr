...
class DevCtrHelloApiWsV1WsStatsRes {
  ...
  bool operator ==(Object other) =>
      ...
      other is DevCtrHelloApiWsV1WsStatsRes &&
  ...
  @override
  String toString() =>
      'DevCtrHelloApiWsV1WsStatsRes[totalConnections=$totalConnections, activeConnections=$activeConnections, messagesSent=$messagesSent, messagesReceived=$messagesReceived, totalRooms=$totalRooms]';
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "DevCtrHelloApiWsV1WsStatsRes[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "DevCtrHelloApiWsV1WsStatsRes[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<DevCtrHelloApiWsV1WsStatsRes> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<DevCtrHelloApiWsV1WsStatsRes>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = DevCtrHelloApiWsV1WsStatsRes.listFromJson(
          entry.value,
          growable: growable,
        );
      }
