...
class DevCtrHelloApiKvV1KvDeleteReq {
  /// Returns a new [DevCtrHelloApiKvV1KvDeleteReq] instance.
  DevCtrHelloApiKvV1KvDeleteReq({
    this.key,
  });
  ...
  /// Returns a new [DevCtrHelloApiKvV1KvDeleteReq] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static DevCtrHelloApiKvV1KvDeleteReq? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return DevCtrHelloApiKvV1KvDeleteReq(
  ...
  static List<DevCtrHelloApiKvV1KvDeleteReq> listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = DevCtrHelloApiKvV1KvDeleteReq.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, DevCtrHelloApiKvV1KvDeleteReq> mapFromJson(dynamic json) {
    final map = <String, DevCtrHelloApiKvV1KvDeleteReq>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = DevCtrHelloApiKvV1KvDeleteReq.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
