...
class DevCtrHelloApiKvV1KvSetReq {
  /// Returns a new [DevCtrHelloApiKvV1KvSetReq] instance.
  ...
  /// Returns a new [DevCtrHelloApiKvV1KvSetReq] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static DevCtrHelloApiKvV1KvSetReq? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return DevCtrHelloApiKvV1KvSetReq(
  ...
  static List<DevCtrHelloApiKvV1KvSetReq> listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = DevCtrHelloApiKvV1KvSetReq.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, DevCtrHelloApiKvV1KvSetReq> mapFromJson(dynamic json) {
    final map = <String, DevCtrHelloApiKvV1KvSetReq>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = DevCtrHelloApiKvV1KvSetReq.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
