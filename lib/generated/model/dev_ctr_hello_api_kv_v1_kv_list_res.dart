...
class DevCtrHelloApiKvV1KvListRes {
  ...
  bool operator ==(Object other) =>
      ...
      other is DevCtrHelloApiKvV1KvListRes &&
  ...
  int get hashCode =>
      ...
      (items.hashCode) + (total == null ? 0 : total!.hashCode);

  @override
  String toString() =>
      'DevCtrHelloApiKvV1KvListRes[items=$items, total=$total]';
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "DevCtrHelloApiKvV1KvListRes[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "DevCtrHelloApiKvV1KvListRes[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<DevCtrHelloApiKvV1KvListRes> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<DevCtrHelloApiKvV1KvListRes>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = DevCtrHelloApiKvV1KvListRes.listFromJson(
          entry.value,
          growable: growable,
        );
      }
