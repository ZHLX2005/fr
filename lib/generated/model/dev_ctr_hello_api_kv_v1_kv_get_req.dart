...
class DevCtrHelloApiKvV1KvGetReq {
  ...
  bool operator ==(Object other) =>
      ...
      other is DevCtrHelloApiKvV1KvGetReq && other.key == key;
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "DevCtrHelloApiKvV1KvGetReq[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "DevCtrHelloApiKvV1KvGetReq[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<DevCtrHelloApiKvV1KvGetReq> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<DevCtrHelloApiKvV1KvGetReq>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = DevCtrHelloApiKvV1KvGetReq.listFromJson(
          entry.value,
          growable: growable,
        );
      }
