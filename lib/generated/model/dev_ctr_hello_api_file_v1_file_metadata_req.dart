...
class DevCtrHelloApiFileV1FileMetadataReq {
  ...
  bool operator ==(Object other) =>
      ...
      other is DevCtrHelloApiFileV1FileMetadataReq && other.id == id;
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "DevCtrHelloApiFileV1FileMetadataReq[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "DevCtrHelloApiFileV1FileMetadataReq[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<DevCtrHelloApiFileV1FileMetadataReq> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, DevCtrHelloApiFileV1FileMetadataReq> mapFromJson(
      dynamic json) {
  ...
  static Map<String, List<DevCtrHelloApiFileV1FileMetadataReq>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = DevCtrHelloApiFileV1FileMetadataReq.listFromJson(
          entry.value,
          growable: growable,
        );
      }
