...
class DevCtrHelloApiFileV1FileUploadReq {
  ...
  bool operator ==(Object other) =>
      ...
      other is DevCtrHelloApiFileV1FileUploadReq &&
          other.file == file &&
          other.ttl == ttl;
  ...
  int get hashCode =>
      ...
      (file == null ? 0 : file!.hashCode) + (ttl.hashCode);

  @override
  String toString() =>
      'DevCtrHelloApiFileV1FileUploadReq[file=$file, ttl=$ttl]';
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "DevCtrHelloApiFileV1FileUploadReq[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "DevCtrHelloApiFileV1FileUploadReq[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<DevCtrHelloApiFileV1FileUploadReq> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, DevCtrHelloApiFileV1FileUploadReq> mapFromJson(
      dynamic json) {
  ...
  static Map<String, List<DevCtrHelloApiFileV1FileUploadReq>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = DevCtrHelloApiFileV1FileUploadReq.listFromJson(
          entry.value,
          growable: growable,
        );
      }
