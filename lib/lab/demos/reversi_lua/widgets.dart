...
// 黑白翻转棋 Lua 版 — UI 组件：OnlineGamePage（入口页 LobbyEntryPage 已迁出，
// 由 lib/core/game_kit/lobby/GameLobbyPage 通用壳统一承载 —— 详见
...
// 场景设计，硬编码保留）。黑白棋棋子本体（#1A1A1A 黑 / #FAFAFA 白）是国际
// 黑白棋视觉识别色，保留。
...
class _OnlineGamePageState extends State<OnlineGamePage> {
  ...
  Widget _buildTurnBar(BoardThemeData theme, bool isBlackTurn) {
    ...
    final myColor =
        _imBlack ? Theme.of(context).colorScheme.onSurface : Theme.of(context).colorScheme.surface;
